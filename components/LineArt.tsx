...
export function StepCallIllustration({ className = "", size = 64, ...props }: LineArtProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      {/* Phone handset */}
      <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" />
      {/* Call waves radiating */}
      <path d="M14.05 2a9 9 0 0 1 7.9 7.9" stroke="var(--color-accent)" strokeWidth="1.5" />
      <path d="M10.05 6a5 5 0 0 1 3.9 3.9" stroke="var(--color-accent)" strokeWidth="1.5" strokeDasharray="1.5 1.5" />
    </svg>
  );
}

// Step 2: Saral AI answers in their language
export function StepAnswerIllustration({ className = "", size = 64, ...props }: LineArtProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      {/* Letter 'अ' representation */}
      <path d="M7.5 8.5h3M7.5 11h3M9 8.5v4" stroke="var(--color-accent)" strokeWidth="1.2" />
      {/* Answering voice bars (sound waves) */}
      <line x1="14" y1="10" x2="14" y2="14" stroke="var(--color-accent)" strokeWidth="1.5" />
      <line x1="16" y1="8" x2="16" y2="16" stroke="var(--color-accent)" strokeWidth="1.5" />
      <line x1="18" y1="11" x2="18" y2="13" stroke="var(--color-accent)" strokeWidth="1.5" />
    </svg>
  );
}

// Step 3: WhatsApp summary delivery
export function StepSummaryIllustration({ className = "", size = 64, ...props }: LineArtProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <line x1="8" y1="7" x2="16" y2="7" strokeOpacity="0.4" />
      <line x1="8" y1="11" x2="14" y2="11" strokeOpacity="0.4" />
      <line x1="8" y1="15" x2="12" y2="15" strokeOpacity="0.4" />
      {/* WhatsApp badge */}
      <g transform="translate(14, 14)">
        <circle cx="5" cy="5" r="5" fill="var(--color-surface)" stroke="var(--color-icon-green)" strokeWidth="1.5" />
        <path d="M3 5l1.5 1.5 2.5-3" stroke="var(--color-icon-green)" strokeWidth="1.5" />
      </g>
    </svg>
  );
}
